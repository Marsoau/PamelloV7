...
public class UpdatablePageMessage : UpdatableMessage
{
    ...
    public UpdatablePageMessage(DiscordCommand command, int lifetimeSeconds, Func<UpdatableMessage, Task> refresh, Func<Task> delete)
        : base(command, lifetimeSeconds, refresh, delete)
    { }
