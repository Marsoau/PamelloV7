    ...
    public IMessageComponentProperties?[] Build() {
        ...
        container.AddComponents(
            MediaGalleryProperties.Create([
                new MediaGalleryItemProperties(new ComponentMediaProperties("https://github.com/user-attachments/assets/7921bb74-e682-4f0b-9db3-7fa0b354cc9c"))
            ]),
            ...
            new ComponentSeparatorProperties(),
            MediaGalleryProperties.Create([
                new MediaGalleryItemProperties(new ComponentMediaProperties("https://github.com/user-attachments/assets/d71e8fdc-8efd-4dd2-ae2d-cb3ec80d04c0"))
            ]),
            new TextDisplayProperties(
                """
