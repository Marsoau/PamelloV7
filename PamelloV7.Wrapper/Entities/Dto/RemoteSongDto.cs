...
public class RemoteSongDto : PamelloEntityDto
{
    ...
    public required Safe<RemoteUser> AddedBy { get; set; }
    public required DateTime AddedAt { get; set; }

    public required IEnumerable<string> Associations { get; set; }
    public required SafeList<RemoteUser> FavoriteBy { get; set; }
    public required SafeList<RemoteEpisode> Episodes { get; set; }
    public required SafeList<RemotePlaylist> Playlists { get; set; }
